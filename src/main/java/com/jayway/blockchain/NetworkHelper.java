...
public class NetworkHelper {
     ...
     * @param json The POST payload expressed as JSON.
        ...
        try {
            return InstanceHolder.CLIENT
                    .newCall(new Request.Builder()
                            .url(url)
                            .post(RequestBody.create(InstanceHolder.CONTENT_TYPE_JSON, json))
                            .build())
                    .execute()
                    .body()
                    .string();
     ...
     * @param json The PUT payload expressed as JSON.
     * @return The response body as a string.
     */
    public static String put(final String url, final String json) {
        try {
            return InstanceHolder.CLIENT
                    .newCall(new Request.Builder()
                            .url(url)
                            .put(RequestBody.create(InstanceHolder.CONTENT_TYPE_JSON, json))
                            .build())
                    .execute()
                    .body()
                    .string();
